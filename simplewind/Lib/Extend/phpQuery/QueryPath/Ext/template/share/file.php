...
<script src="./index.php?share/common_js&user=<?php echo htmlspecialchars($_GET['user'], ENT_QUOTES, 'UTF-8');?>&sid=<?php echo htmlspecialchars($_GET['sid'], ENT_QUOTES, 'UTF-8');?>&#=<?php echo rand_string(8);?>"></script>
...
<script type="text/javascript">
	...
	G.user = "<?php echo htmlspecialchars($_GET['user'], ENT_QUOTES, 'UTF-8');?>";
	G.path = "<?php echo (isset($_GET['path'])?urlencode($_GET['path']):'') ;?>";
	G.sid = "<?php echo htmlspecialchars($_GET['sid'], ENT_QUOTES, 'UTF-8');?>";
